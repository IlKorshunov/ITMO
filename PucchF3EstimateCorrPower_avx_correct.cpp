                       ...
                       float (&corrPower)[maxUlAntennaPortNum])
{
    ...
    else if (numOfAnts == 4)
    {
        ...
        __m256i real_idx = _mm256_setr_epi32(0, 2, 4, 6, 0, 0, 0, 0);
        __m256i imag_idx = _mm256_setr_epi32(1, 3, 5, 7, 0, 0, 0, 0);

        __m256 c0_real = _mm256_permutevar8x32_ps(c0_vec, real_idx);
        __m256 c0_imag = _mm256_permutevar8x32_ps(c0_vec, imag_idx);
        __m256 c1_real = _mm256_permutevar8x32_ps(c1_vec, real_idx);
        __m256 c1_imag = _mm256_permutevar8x32_ps(c1_vec, imag_idx);
