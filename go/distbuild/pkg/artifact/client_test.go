...
// создает 2 кэша, в один из них создает подкаталог с байтами foobar
// а затем коммитит его. Потом создает для него handler
// регистрирует обработчик запросов для данного кэша и регистрирует его
// загружает из удаленного кэша в локальный данные с помощью моего Download
// пытаеться достать из локального кэша строку foobar
